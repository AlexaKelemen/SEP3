...
builder.Services.AddDbContext<AppDbContext>(options => options.UseSqlite(@"Data Source=C:\Users\user\RiderProjects\SEP3\SEP3_CSharp\DatabaseConnection\database.db"));
